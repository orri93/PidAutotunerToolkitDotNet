#ifndef GOS_PID_TUNING_UI_MODEL_RANGE_H_
#define GOS_PID_TUNING_UI_MODEL_RANGE_H_
...
namespace model { class Range; } } } } }

bool operator==(
  const ::gos::pid::toolkit::ui::model::Range& lhs,
  const ::gos::pid::toolkit::ui::model::Range& rhs);
bool operator!=(
  const ::gos::pid::toolkit::ui::model::Range& lhs,
  const ::gos::pid::toolkit::ui::model::Range& rhs);

int compare(
  const ::gos::pid::toolkit::ui::model::Range& first,
  const ::gos::pid::toolkit::ui::model::Range& second);
