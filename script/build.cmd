...
SET GOS_OPENSSL_DIR=C:/install/openssl/openssl-release-win64
...
-DGOS_PID_TOOLKIT_UI:BOOL=ON ^
-DGOS_DEPLOY_PDB_FILES:BOOL=ON ^
-DGOS_PID_TOOLKIT_SERVICE:BOOL=ON ^
...
-DOPENSSL_ROOT_DIR:PATH="%GOS_OPENSSL_DIR%" ^
