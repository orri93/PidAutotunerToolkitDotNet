...
SET GOS_QML_PLUGIN_DUMP_CMD="%GOS_QML_PLUGIN_DUMP_EXE%" -output "%GOS_QML_PLUGIN_DIR%\Pid\Toolkit\plugin.qmltypes" %GOS_QML_PLUGIN% %GOS_QML_PLUGIN_VERSION% "%GOS_QML_PLUGIN_DIR%"
